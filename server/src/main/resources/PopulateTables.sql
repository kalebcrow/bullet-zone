BEGIN NOT ATOMIC
    ...
    VALUES
        ...
        (12, 'Standard truck frame', 1, 4.0, 1.0, 150.0, 4.0, 5.0, 0.0),
        (13, 'Standard battle suit', 1, 0.0, 0.1, 40.0, 0.5, 3.0, 0.0),
        -- Weapons
        (21, 'Standard tank cannon', 2, 3.0, 4.0, 200.0, 30.0, 4.0, 2),
        (22, 'Plasma cannon', 2, 1.0, 1.0, 120.0, 5.0, 1.0, 4),
        (23, 'Particle beam gun', 2, 0.1, 0.1, 50.0, 1.0, 0.1, 6),
        -- Generators
        ...
        -- Drives
        (51, 'Standard tank drive tracks', 5, 4.0, 3.0, 60.0, 4.0, 25.0, 0.0),
        (52, 'Standard truck drive wheels', 5, 1.0, 1.0, 20.0, 2.0, 12.0, 0.0),
        (53, 'Battle-suit leg assists', 5, 0.1, 0.1, 7.0, 0.1, 0.5, 0.0),
        -- ** Power-ups **
        (111, 'Grav-assist', 11, 1.0, 0.0, 300.0, 0.4, 0.5, 0.0),
        (121, 'Fusion generator', 12, 1.0, 2.0, 400.0, 2.0, 1.0, 0.0),
